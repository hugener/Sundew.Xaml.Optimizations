...
namespace Sundew.Xaml.Optimizations.Bindings.Converters
{
    ...
    public class CastingValueConverter<TSource, TTarget> : IValueConverter<TSource, TTarget>
    {
        ...
        public TTarget Convert(TSource source, Type targetType, object parameter, string language)
        {
            return (TTarget)this.valueConverter.Convert(source, targetType, parameter, language);
        }
        ...
        {
            return this.valueConverter.Convert(value, targetType, parameter, language);
        }
        ...
        public TSource ConvertBack(TTarget target, Type targetType, object parameter, string language)
        {
            return (TSource)this.valueConverter.ConvertBack(target, targetType, parameter, language);
        }
        ...
        {
            return this.valueConverter.ConvertBack(value, targetType, parameter, language);
        }
    }
}