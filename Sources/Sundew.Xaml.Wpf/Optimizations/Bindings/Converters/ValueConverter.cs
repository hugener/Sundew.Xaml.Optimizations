...
namespace Sundew.Xaml.Optimizations.Bindings.Converters
{
    ...
    public abstract class ValueConverter<TSource, TTarget> : MarkupExtension, IValueConverter<TSource, TTarget>
    {
        ...
        public abstract TTarget Convert(TSource source, Type targetType, object parameter, CultureInfo cultureInfo);
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return this.Convert(source, targetType, parameter, culture);
        }
        ...
        public abstract TSource ConvertBack(TTarget target, Type targetType, object parameter, CultureInfo cultureInfo);
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return this.ConvertBack(target, targetType, parameter, culture);
        }
    }
}